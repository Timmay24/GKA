...
import controller.JGraphController;

public class CopyOfMainWindow {
	
	private			GuiController		guiController;
//	private 		GraphController 	graphController;
	private			JGraphController	jGraphController;
	...
	public static void start(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CopyOfMainWindow mainWindow = new CopyOfMainWindow();
	...
	private void initialize() {
		...
		jGraphController = new JGraphController();
		
		graphPanel = new JPanel();
		graphPanel.setBackground(Color.LIGHT_GRAY);
		graphPanel.setBounds(10, 11, 774, 326);
		graphPanel.add( jGraphController.getGraphComponent() );
